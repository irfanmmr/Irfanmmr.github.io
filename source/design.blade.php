...
<div class="w-full flex flex-col">
    <div class="w-full h-screen flex flex-col">
        <div class="w-full my-auto flex-col flex items-center space-y-5">
            <div class="flex flex-col space-y-3 lg:space-y-5 -mt-52 lg:-mt-48">
            ...
            <div class="flex lg:flex-row px-5 lg:px-12 bottom-32 lg:bottom-10 absolute w-full justify-between">
