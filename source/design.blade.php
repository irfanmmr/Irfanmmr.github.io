...
<div class="w-full flex flex-col">
    <div class="w-full h-screen flex flex-col">
        <div class="w-full my-auto flex-col flex items-center space-y-5">
            <div class="flex flex-col space-y-3 lg:space-y-0 -mt-52 lg:-mt-48">
                <p class="text-beatrice text-2xl lg:text-5xl leading-normal mx-auto w-8/12 text-center">
            ...
            <div class="flex lg:flex-row px-5 lg:px-12 bottom-48 lg:bottom-6 absolute w-full justify-between">
